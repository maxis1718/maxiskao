...
def show(section='profile'):
	...
	if section == 'projects':
		...
		return render_template(section+'.html', selected=selected, triangle=triangle, projects=projects)
...
if __name__ == "__main__":
	...
	# with app.test_request_context():
		...
		# print url_for('show_projects')
	# 	print url_for('show_publications')
	# 	print url_for('show_about')
	# 	print url_for('statis_img')
